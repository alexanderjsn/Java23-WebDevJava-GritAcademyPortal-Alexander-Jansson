...
public class Samestudentcourses extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<CourseParticipant> allStudentCourses = studentsCoursesDAO.selectSameStudentCourses(username);
        request.setAttribute("allStudentCourses", allStudentCourses);
        RequestDispatcher dispatcher = request.getRequestDispatcher("studentsinclass.jsp");
